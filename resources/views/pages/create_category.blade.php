   ...
   <div class="section content_section">
	<div class="container">
		<div class="filable_form_container">
         ...
         {{ Form::open(array('id'=>'frm_add_category','url'=>route('add_category'), 'method'=>'post')) }}
			
				

				{!! Form::Label('CategoryName', 'Category Name', ['class'=>'required']) !!}
    		 {!! Form::text('category_name', '', ['placeholder'=>'Enter Category Name', 'id'=>'category_name','data-parsley-required data-parsley-pattern="^[a-zA-Z]+$"']) !!}
